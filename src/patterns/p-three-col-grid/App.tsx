...
const SubGridCol: FC<Props> = ({ sgHeader, sgContent, sgFooter }) => {
  return (
    <div className="p-3-col-grid__col">
      <header className="p-3-col-grid__col-header">{sgHeader}</header>
      <p className="p-3-col-grid__col-content">{sgContent}</p>
      <footer className="p-3-col-grid__col-footer">
        <hr />
        {sgFooter}
      </footer>
    </div>
...
function App() {
  return (
    <div className="app">
      <div className="demo p-3-col-grid">
        <div className="p-3-col-grid__title">
          <a href="#">{'LATEST FROM OUR BLOG >'}</a>
        </div>
        <div className='p-3-col-grid__content-grid'>
          <div className="p-3-col-grid__row">
            <SubGridCol
